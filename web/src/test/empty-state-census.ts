...
//
// THE EMPTY-STATE CENSUS (D21) — the second instrument over the console's empty states.
//
...
/** The one number the D21 oracle names: empty states that say nothing useful. */
