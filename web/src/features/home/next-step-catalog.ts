...
//
// WHICH VERB, WHERE IT LIVES, AND WHAT AUTHORIZES IT.
//
...
// count is a measured control — an earlier pass proved its 42 rule violations were
// repaired and not demoted by showing the warning count identical before and after.
