...
// D19: the two steps that were missing from a wizard whose stated subject is the
...
export function OnboardingView() {
  ...
  // D19. Both reads are the AUTHORITATIVE ones for their step, in the same spirit as
  ...
  // D19 step 6. A registered provider is NOT verified: registering is not evidence
  ...
  // D19 step 7. Verified means a session RAN under a profile that names a credential.
...
// --- step 7: agents and the first session (D19) ------------------------------
