...
//
// The console keeps the scope of whatever you do next on screen: the things an Olivares
// action applies to. On a SIGNED-OUT screen there is no tenant and no workspace yet, so
// the scope is the deployment: the address you are about to hand a password to, and the
// version that will answer.
//
