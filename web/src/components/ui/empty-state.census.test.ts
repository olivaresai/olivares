...
//
// THE EMPTY-STATE CENSUS, driven by MUTANTS before it is believed about the tree.
//
// An earlier review published a list of 94 `<EmptyState>` call sites carrying neither a
// description nor an action. A list is a starting point, not a guarantee: the 95th is written the
