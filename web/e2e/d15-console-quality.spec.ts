...
//
// D15 — keyboard and labelled controls on the ten routes the brief names, against
// a live `--seed-demo` engine. Nothing on this path is intercepted.
//
...
test.describe('D15 keyboard on the ten named routes', () => {
  test.beforeEach(() => {
    test.skip(
      !demoTenant,
