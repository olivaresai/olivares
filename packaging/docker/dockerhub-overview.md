...
|-----|----------|---------------|
| `26.9.1`, `latest` | Base engine + embedded web console | amd64, arm64 |
| `26.9.1-fips` | FIPS 140-3 build (`GOFIPS140`, CMVP-validated module) | amd64 |
| `26.9.1-stig` | STIG-hardened (UBI-micro, OpenSCAP-profiled) base image | amd64 |
...
```sh
cosign verify olivaresai/olivares:26.9.1 \
