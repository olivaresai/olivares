...
CLI Grok как управляемого потомка. Этот путь эксплуатации —
[Управлять сеансом провайдера](/how-to/operate-provider-sessions/)
(`OLIVARES_SESSION_RUNTIME_GROK_BIN` плюс профиль провайдера;
`CHANGELOG.md` `[26.9.0]`). Совместимость с аутентифицированной официальной
