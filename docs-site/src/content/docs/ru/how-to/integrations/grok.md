...
сеанс, используйте [Установить CLI Grok](/how-to/install-grok-cli/). Путь
эксплуатации —
[Управлять сеансом провайдера](/how-to/operate-provider-sessions/)
(`OLIVARES_SESSION_RUNTIME_GROK_BIN` или квитанция управляемой установки, плюс
профиль провайдера). Совместимость с аутентифицированной официальной
учётной записью Grok там не утверждается.
