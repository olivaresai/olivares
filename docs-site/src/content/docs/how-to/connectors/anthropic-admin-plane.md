...
description: >-
  Govern the Claude organization itself: authoritative billed cost and usage
  via the Admin API, API-side MCP and server-tool allow-sets as permitted
  edges, the compliance activity feed and org directory — each credential
  scoped, each blind spot named.
sidebar:
  order: 6
---
...
those surfaces the [OTel plane](/how-to/claude-code-enterprise-otel/) is the
...
<img class="light:sl-hidden" src="/console/finops-dark.png" alt="The Cost & FinOps view: spend by model and dimension, with budgets and alerts." />
<img class="dark:sl-hidden" src="/console/finops-light.png" alt="The Cost & FinOps view: spend by model and dimension, with budgets and alerts." />
...
- [Budgets & FinOps guardrails](/how-to/cookbook/budgets-and-finops-guardrails/)
