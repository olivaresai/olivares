...
description: >-
  Gate destructive actions behind governed approvals: open a request bound to
  the exact plan, let authorized humans decide with separation-of-duty and
  expiry enforced server-side, and get the decision recorded in the ledger.
sidebar:
  order: 3
---
...
[governance model](/how-to/govern-and-approve/#the-human-in-the-loop-posture)
...
immutable trail, and the [pull export](/how-to/forward-audit-to-splunk/)
