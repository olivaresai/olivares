...
description: >-
  One call stops every governed actuation in the estate — or one agent. Fast
  to engage by design; re-enabling takes two humans, and the incident leaves
  an evidence pack. Drill it before you need it.
sidebar:
  order: 5
---
...
<img class="light:sl-hidden" src="/console/killswitch-dark.png" alt="The Kill switch console view: estate state and per-stop history." />
<img class="dark:sl-hidden" src="/console/killswitch-light.png" alt="The Kill switch console view: estate state and per-stop history." />
