...
description: Inventory every MCP server your agents can reach, treat its
  self-declared hints as untrusted by spec, scan the catalog for tool-poisoning
  and posture issues, and reconcile against the public and federated registries.
sidebar:
  order: 7
slug: 2026-06/how-to/connectors/mcp-governance
---
...
![The MCP & skills view: the live capability catalog with servers, tools, wiring and managed configs.](../../../../../assets/console/2026-06/capabilities-light.png)
...
* [Connect Claude Code](/2026-06/how-to/connect-claude-code/) — where MCP hints meet
  session telemetry.
* [Module V — MCP, skills & capabilities](/2026-06/reference/modules/v-capabilities/).
* [Build and ship a connector](/2026-06/how-to/build-a-connector/) — the deny-closed
