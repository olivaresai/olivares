...
description: "Wire enterprise identity end to end: federated console login
  (OIDC/SAML through the federation seam), SCIM provisioning into the control
  plane, and the LDAP / Okta / Entra roster sources that upgrade access-map
  attribution from approximate to firm."
sidebar:
  order: 8
slug: 2026-06/how-to/connectors/sso-scim-identity
---
...
![The Identity & NHI view: SSO configuration with exact redirect-URI checking, the NHI roster, and key posture tabs.](../../../../../assets/console/2026-06/identity-light.png)
...
([the bridge to governance](/2026-06/how-to/govern-and-approve/)).
...
* [Connect a source](/2026-06/how-to/connect-a-source/#the-hard-dependency-per-agent-identity)
  — why identity is the hard dependency.
* [Govern and approve](/2026-06/how-to/govern-and-approve/) — roles, RBAC and what a
  `mapped_role` grants.
* [Connectors & coverage tiers](/2026-06/reference/connectors/) — the full identity
