...
description: "The governance half of the Claude Code connector: hooks observed
  by default, and an opt-in policy enforcement point that answers PreToolUse /
  PermissionRequest hooks with deny or ask — every gate recorded as a finding."
sidebar:
  order: 5
slug: 2026-06/how-to/connectors/claude-code-hooks-pep
---

[Connect Claude Code](/2026-06/how-to/connect-claude-code/) wires the *observation*
...
[emergency stop](/2026-06/how-to/cookbook/kill-switch-drill/), `claude.tool.use` is
...
![The Claude Code governance view — policy authoring and fleet posture in one place.](../../../../../assets/console/2026-06/claude-policy-light.png)
...
* **The PEP gates what hooks report.** A host whose hooks are not configured
  ...
  [kernel backstop](/2026-06/how-to/connectors/ebpf-tetragon/) so it is not blind.
...
* **Subprocesses are out of scope here** (hooks fire for Claude Code's own
  tool calls); see the
  [enterprise OTel page](/2026-06/how-to/claude-code-enterprise-otel/) for what the
  telemetry env does and does not reach.

## Related

* [Connect Claude Code](/2026-06/how-to/connect-claude-code/) — the observation half.
* [Enterprise OTel for Claude Code](/2026-06/how-to/claude-code-enterprise-otel/) —
  fleet telemetry, labels, tracing.
* [Govern and approve](/2026-06/how-to/govern-and-approve/) — the authorization model
  the PEP plugs into.
