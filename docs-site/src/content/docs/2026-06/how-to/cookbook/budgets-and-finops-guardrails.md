...
description: "Put a hard dollar limit on AI spend — per model, team, workspace
  or a single identity: alert at thresholds, then throttle or block at the cap.
  Plus cost-per-outcome so the spend has a denominator."
sidebar:
  order: 2
slug: 2026-06/how-to/cookbook/budgets-and-finops-guardrails
---
...
provisioning ([the modules catalog](/2026-06/reference/modules/overview/) marks it
`v1 | v1`).
...
[identity sources](/2026-06/how-to/connectors/sso-scim-identity/) registered:
...
PagerDuty [destination](/2026-06/how-to/forward-audit-to-splunk/) hears the 80%
crossing before the 100% denial.

In the console, **Cost & FinOps** shows spend by dimension with budget
status inline:

![The Cost & FinOps view with spend trends and budget posture.](../../../../../assets/console/2026-06/finops-light.png)
