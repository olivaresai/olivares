...
description: "Work a Permitted-vs-Observed result to zero: classify unexpected
  accesses, unused grants and reconciliation-pending edges, decide each one
  (grant, revoke, or fix identity), and re-check — without trusting a single
  hint."
sidebar:
  order: 4
slug: 2026-06/how-to/cookbook/drift-triage
---
...
[manage as code](/2026-06/how-to/manage-as-code/).)
...
* `approximate` attribution means the *access* happened but the *who* is a
  ...
  the durable fix is
  [per-agent identity](/2026-06/how-to/connectors/sso-scim-identity/), and until
...
celebrating ([tiered coverage](/2026-06/how-to/connect-a-source/#tiered-coverage--be-realistic)).
...
([Terraform](/2026-06/how-to/manage-as-code/)) or via the governed API, gate the
risky direction behind an [approval](/2026-06/how-to/cookbook/hitl-approvals/), and
...
([quickstart](/2026-06/start/quickstart/)).

In the console, the **Access map**'s *Permitted vs observed* panel is this
recipe rendered live:

![The drift panel: unexpected accesses, pending reconciliation and unused grants, each honestly labeled.](../../../../../assets/console/2026-06/access-map-drift-light.png)
...
your on-call via a [notification destination](/2026-06/how-to/forward-audit-to-splunk/)
