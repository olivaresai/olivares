...
description: "The operator's failure-mode guide, distilled from the product's
  own runbooks: boot and first-run problems, readiness failures, ingest
  backpressure, ledger verification failures, and the warnings the engine prints
  on purpose."
slug: 2026-06/how-to/troubleshooting
---
...
```text
generated a new audit signing key; back it up
generated a self-signed TLS certificate; clients must trust it or pin its fingerprint
```
...
([backup & restore](/2026-06/how-to/backup-and-restore/#the-two-keys-that-decide-everything)).
...
([the pgAudit guide](/2026-06/how-to/connectors/pgaudit/)):
...
[triage it](/2026-06/how-to/cookbook/drift-triage/) by declaring the grants you
intend.
...
([push to SIEM](/2026-06/how-to/cookbook/push-to-siem/)).
