...
description: Point Claude Code's OpenTelemetry exporter at the engine and wire
  it as a source so its tool telemetry — plus untrusted MCP introspection —
  feeds the R/RW access map.
slug: 2026-06/how-to/connect-claude-code
---
...
[Connect a source](/2026-06/how-to/connect-a-source/) and the
[architecture overview](/2026-06/explanation/architecture/overview/). For the shape of the
normalized events this produces, see the [events reference](/2026-06/reference/events/).
...
(see [Honesty and limits](/2026-06/start/honesty-and-limits/)). For activity outside the
...
[the configuration reference](/2026-06/reference/configuration/) — for the authoritative,
...
[Zero to graph tutorial](/2026-06/tutorials/zero-to-graph/).
...
* [Connect a source](/2026-06/how-to/connect-a-source/) — the general source-wiring model
  (cooperative and non-cooperative).
* [Govern and approve](/2026-06/how-to/govern-and-approve/) — turn observed drift into a
  least-privilege decision.
* [Events reference](/2026-06/reference/events/) — the normalized observations this source
  emits.
* [Architecture overview](/2026-06/explanation/architecture/overview/) — where the
