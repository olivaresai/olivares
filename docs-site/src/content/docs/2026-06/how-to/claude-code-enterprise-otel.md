...
description: "The recommended enterprise telemetry posture for a Claude Code
  fleet: managed-settings env that turns the sanctioned OTel export on, operator
  labels via OTEL_RESOURCE_ATTRIBUTES that become FinOps dimensions, the tracing
  beta for subagent hierarchy, and the privacy knobs — with their duties —
  spelled out."
slug: 2026-06/how-to/claude-code-enterprise-otel
---
...
[Connect Claude Code](/2026-06/how-to/connect-claude-code/): what to set fleet-wide, what
...
The managed `env` block configures the **Claude Code process**. OTEL\_\* variables
...
* **Unauthenticated loopback ingest.** The cooperative receiver binds loopback
  ...
  [Connect Claude Code](/2026-06/how-to/connect-claude-code/)).
* **Subprocesses are not covered.** OTEL\_\* does not reach Bash/hook/MCP
...
* **The admin-plane feed cannot see third-party providers.** The Claude Code
  ...
  Microsoft Foundry, Amazon Bedrock and Gemini Enterprise Agent Platform (formerly Vertex AI) are not included. For a fleet
...
* [Connect Claude Code](/2026-06/how-to/connect-claude-code/) — the base wiring this
  page builds on.
* [Govern and approve](/2026-06/how-to/govern-and-approve/) — the enforcement half
  (managed settings, hooks, the PEP).
* [Forward audit to Splunk](/2026-06/how-to/forward-audit-to-splunk/) — ship the
