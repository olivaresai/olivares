...
description: Verify a release's signature, SLSA provenance, SBOM and OpenVEX
  attestations before you run it — online (keyless) or fully offline
  (key-based). Never pipe an installer straight into a shell.
slug: 2026-06/how-to/verify-a-release
---
...
scripts/verify-release.sh --source-tag v1.2.3
```
...
5. **SLSA provenance:**
   ...
   slsa-verifier verify-artifact <artifact> \
     ...
     --source-uri 'github.com/<public-owner>/<public-repository>'
   ```
...
slsa-verifier verify-image "$REF" \
  --source-uri 'github.com/<public-owner>/<public-repository>' --source-tag <version>
```
