...
description: "The control plane over the authorization model: identity roster
  reconciliation, the agent↔identity bridge, the deny-only ABAC engine, and the
  human-in-the-loop approval gate with an append-only decision trail. The root
  of governed actuation."
slug: 2026-06/reference/modules/vi-governance
---
...
[event bus](/2026-06/reference/events/) — a **shared identity** bound to more than one agent,
...
* [Modules catalog](/2026-06/reference/modules/overview/) — where Module VI sits and its honest actuation status.
* [Access & resource map (III)](/2026-06/reference/modules/iii-access-map/) — the consumer whose attribution dependency this module resolves.
* [Event bus reference](/2026-06/reference/events/) — the `finding.reported` event this module emits.
* [Govern and approve](/2026-06/how-to/govern-and-approve/) — using the policy and approval surfaces.
* [Architecture overview](/2026-06/explanation/architecture/overview/) — the engine and layers this module composes onto.
* [Honesty & limits](/2026-06/start/honesty-and-limits/) — the deny-closed, detective-by-default posture.
