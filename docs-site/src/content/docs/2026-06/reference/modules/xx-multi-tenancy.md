...
description: "The isolation foundation: every core entity carries a tenant_id,
  and the store refuses to open unless that boundary is enforced at the query
  layer. What the data model guarantees today, and what org hierarchy and
  delegated admin still are."
slug: 2026-06/reference/modules/xx-multi-tenancy
---
...
tenant's [hash-chained audit ledger](/2026-06/reference/events/) within the same transaction.
...
* **Tenancy is not delegated administration.** Who may act *within* a tenant — roles,
  approvals, segregation of duties — is governed by [module VI](/2026-06/reference/modules/vi-governance/),
...
* [Modules catalog](/2026-06/reference/modules/overview/) — where module XX sits and its honest actuate status.
* [Identity, permissions & governance](/2026-06/reference/modules/vi-governance/) — roles and delegated authority within a tenant.
* [Architecture overview](/2026-06/explanation/architecture/overview/) — the engine layer and the general data model.
* [Event bus reference](/2026-06/reference/events/) — the per-tenant audit ledger every mutation appends to.
* [Honesty & limits](/2026-06/start/honesty-and-limits/) — what is built today versus design-stage.
