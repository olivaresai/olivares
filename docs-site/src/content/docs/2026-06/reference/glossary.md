---
title: Glossary
description: "The product's vocabulary, precisely: the access map and its
  honesty axes, the observation kinds, the governance primitives, and the
  operational terms — each defined the way the engine actually uses it."
slug: 2026-06/reference/glossary
---
...
and [coverage tier](#coverage-tier). The product's differentiating pillar.
See [What is Olivares AI?](/2026-06/start/what-is-olivares-ai/).
...
interface with no backend. The [modules catalog](/2026-06/reference/modules/overview/)
...
[ledger](#audit-ledger). See the [recipe](/2026-06/how-to/cookbook/hitl-approvals/).
...
[SSO/SCIM & identity sources](/2026-06/how-to/connectors/sso-scim-identity/).
...
See [backup & restore](/2026-06/how-to/backup-and-restore/).
...
[Triage recipe](/2026-06/how-to/cookbook/drift-triage/).
...
and to [SIEM sinks](/2026-06/how-to/cookbook/push-to-siem/).
...
from [identity sources](/2026-06/how-to/connectors/sso-scim-identity/); binding them
...
process to an agent. See [eBPF/Tetragon](/2026-06/how-to/connectors/ebpf-tetragon/).
...
[Drill recipe](/2026-06/how-to/cookbook/kill-switch-drill/).
...
trusted alone. See [MCP governance](/2026-06/how-to/connectors/mcp-governance/).
...
diff is [drift](#drift-least-privilege-drift) — the killer feature.
...
See [build a connector](/2026-06/how-to/build-a-connector/).
...
See [push to SIEM](/2026-06/how-to/cookbook/push-to-siem/).
...
See [monitoring](/2026-06/how-to/monitor-with-prometheus/).
...
See [connect a source](/2026-06/how-to/connect-a-source/).
