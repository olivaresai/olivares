---
title: Integrar Claude Code
description: >-
  Incorpora Claude Code al plano de control de gobierno: el conector, los managed settings,
  el hook PEP gobernado y lo que muestra la consola una vez en funcionamiento.
---
