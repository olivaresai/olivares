...
caducadas o filas de idempotencia huérfanas. `reconciliation` LEE y no cambia
nada; `reconcile` es el trabajo: barre esas reservas, pide permiso de escritura
de presupuestos y es el que emite el hallazgo `finops_reservation_drift`.
Trátelo como postura, no como reescritura del gasto.
