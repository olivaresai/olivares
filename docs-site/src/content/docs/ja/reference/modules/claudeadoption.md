...
asks, served alongside the [FinOps](/ja/reference/modules/xi-finops/) cost surface
...
- [Cost & AI FinOps](/ja/reference/modules/xi-finops/) — the authoritative cost
  surface this module sits beside.
- [Events reference](/ja/reference/events/) — the `metric.sampled` signal it
  consumes.
- [Modules catalog](/ja/reference/modules/overview/) — the 30 modules and their
  honest maturity.
