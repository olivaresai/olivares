...
asks, served alongside the [FinOps](/fr/reference/modules/xi-finops/) cost surface
...
- [Cost & AI FinOps](/fr/reference/modules/xi-finops/) — the authoritative cost
  surface this module sits beside.
- [Events reference](/fr/reference/events/) — the `metric.sampled` signal it
  consumes.
- [Modules catalog](/fr/reference/modules/overview/) — the 30 modules and their
  honest maturity.
