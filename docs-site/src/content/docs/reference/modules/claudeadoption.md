...
asks, served alongside the [FinOps](/reference/modules/xi-finops/) cost surface
...
- [Cost & AI FinOps](/reference/modules/xi-finops/) — the authoritative cost
  surface this module sits beside.
- [Events reference](/reference/events/) — the `metric.sampled` signal it
  consumes.
- [Modules catalog](/reference/modules/overview/) — the 30 modules and their
  honest maturity.
