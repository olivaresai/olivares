...
asks, served alongside the [FinOps](/de/reference/modules/xi-finops/) cost surface
...
- [Cost & AI FinOps](/de/reference/modules/xi-finops/) — the authoritative cost
  surface this module sits beside.
- [Events reference](/de/reference/events/) — the `metric.sampled` signal it
  consumes.
- [Modules catalog](/de/reference/modules/overview/) — the 30 modules and their
  honest maturity.
