...
:::note[Beta — Images für 26.9.0 veröffentlicht]
Olivares AI ist **Beta**. Die Image-Koordinaten unten lösen sich auf: Release `26.9.0` hat sie auf
Docker Hub und `ghcr.io` veröffentlicht (Install-Surface-Zeuge `docs/releases/v26.9.0-install-surfaces.json`).
