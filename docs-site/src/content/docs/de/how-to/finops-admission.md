...
`drift` ist wahr bei abgelaufenen, nicht abgeschlossenen Reserven. FinOps
sendet dann einen Fund `finops_reservation_drift`. Das ist Haltung, keine
stille Korrektur der Ausgaben.
