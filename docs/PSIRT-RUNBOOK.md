...
olivares release manifest --channel security --version 26.9.2 --dir ./dist \
...
olivares release verify-manifest \
  ...
  --expect-channel security --expect-version 26.9.2
...
{ "advisories": [ {
  ...
  "affected": [ { "package": "olivares",
                  "ranges": [ { "introduced": "26.5.0", "fixed": "26.9.2" } ] } ],
...
olivares security check --feed advisories.json --product-version 26.9.1  # what-if / fleet check
```
