...
within that month. The latest public release is `v26.9.0` (September 2026); the next planned
release is `v26.10`, pending. Container tags follow: `:26.9.0`, `:latest`, plus the `-fips` /
