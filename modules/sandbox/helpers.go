...
// Bounds on operator/caller-supplied strings (docs/SECURITY-HARDENING.md — minimal data). Every
// caller-supplied text is clamped before Create.
const (
	maxNameLen   = 200
	maxRefLen    = 1024
	maxStepLen   = 8192
...
// auditEvent appends a sandbox self-audit attributed to the REAL principal in the
// caller's transaction. Every privileged action is auditable (docs/SECURITY-HARDENING.md): creating
// or archiving a scenario, launching a run/replay, deciding a comparison.
