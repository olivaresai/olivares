...
--
-- OT-V, INSERT half. The accepted-Handoff lease-effect rule becomes conditional
...
-- repairing a row, so failure preserves the v61 guard.
...
DROP TRIGGER IF EXISTS sessions_work_handoff_guard_ins;
CREATE TRIGGER sessions_work_handoff_guard_ins
