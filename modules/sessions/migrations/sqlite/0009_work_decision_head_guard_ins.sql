...
CREATE TRIGGER IF NOT EXISTS sessions_work_decision_head_guard_ins
BEFORE INSERT ON sessions_work_decision_head
FOR EACH ROW
BEGIN
	...
	SELECT RAISE(ABORT, 'olivares: decision head parent must exist in the same tenant/workspace')
