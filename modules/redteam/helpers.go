...
// Bounds on operator/caller-supplied strings (docs/SECURITY-HARDENING.md — minimal data).
const (
	maxNameLen   = 200
	maxRefLen    = 1024
	maxReasonLen = 2000
...
// auditEvent appends a red-team self-audit attributed to the REAL principal in the
// caller's transaction. Every red-team action is privileged and auditable (docs/SECURITY-HARDENING.md
// §8): registering a target, authorizing it, launching a run.
